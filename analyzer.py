...
def _warm_universe():
    ...
    # v3.2 — after the universe is fresh, start the polite background pass
    # that collects official filed reports for every listed COMPANY (ETFs and
    # debt instruments are skipped — they have no company fundamentals).
    try:
        import deepdata
    ...
    # v4.0 — build (or refresh) this month's recommended-stocks list in the
    # background so the dashboard card fills in without blocking anything.
    try:
        import recommend
