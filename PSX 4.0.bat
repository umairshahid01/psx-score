...
set "FILES=config.py utils.py psx_data.py scraper.py scorer.py predictor.py deepdata.py catalyst.py recommend.py analyzer.py dashboard.html requirements.txt"
set "DL_OK=1"
